...
function Recruit() {
  ...
  return (
    <div className="sub-recruit-bg">
      <div className="sub-recruit-title">Recruit</div>
      <div
        className={`sub-recruit-front ${tab === 0 ? "active" : ""}`}
        onClick={() => {
          setTab(0);
        }}
      >
      ...
      <div
        className={`sub-recruit-back ${tab === 1 ? "active" : ""}`}
        onClick={() => {
          setTab(1);
        }}
      >
      ...
      <div
        className={`sub-recruit-designer ${tab === 2 ? "active" : ""}`}
        onClick={() => {
          setTab(2);
        }}
      >
      ...
      <div className="sub-recruit-textbox">
        <TabContent tab={tab} />
      </div>
    </div>
  );
...
function FrontEnd() {
  return (
    <>
      <div className="sub-recruit-title2">Front-end</div>
      <div className="sub-recruit-detail">
        안녕하세요. HWA-E 프론트엔드팀입니다. 저희 팀은 매우 화목하고
        열정적입니다! <br /> 이런식으로 짧게 어필할 수 있는 문장을 삽입하세요.
        분량은 1~2줄입니다.{" "}
      </div>
      <div class="sub-recruit-do">주요 활동</div>
      <div class="sub-recruit-doDetail">
        여러 팀과의 긴밀한 협업을 통해 개발 경험을 설계해요.
        <br />
        리액트를 사용해서 평소 개발하고 싶었던 웹을 제작해요. <br />
        여기에 더 추가해야 함~!
      </div>
      <div className="sub-recruit-who">지원 자격</div>
      <ul className="sub-recruit-list">
        <li>HTML, CSS, JS</li>
        <li>리액트 기본 아는 사람</li>
        <li>열정걸</li>
      </ul>
      <div className="sub-recruit-special">우대사항</div>
      <ul className="sub-recruit-list2">
        <li>HTML, CSS, JS</li>
        <li>리액트 기본 아는 사람</li>
        <li>열정걸</li>
      </ul>
      <div className="sub-recruit-recruit">지원하기</div>
    </>
  );
}
...
function BackEnd() {
  return (
    <>
      <div className="sub-recruit-title2">Back-end</div>
      <div className="sub-recruit-detail">
...
function Designer() {
  return (
    <>
      <div className="sub-recruit-title2">Designer</div>
      <div className="sub-recruit-detail">
